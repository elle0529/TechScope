...
Write-Host ""
Write-Host "TechScope P0 Local Dev Container Build v4 AZURE CLI FIXED"
Write-Host "Repository: C:\TechScope"
Write-Host "Resume point: patched Dockerfile -> environment fingerprint -> cached image build"
Write-Host ""
