...
Write-Host ""
Write-Host "TechScope P0 Local Dev Container Build v5 DOTNET RUNTIME FIXED"
Write-Host "Repository: C:\TechScope"
Write-Host "Resume point: patched .NET runtime -> environment fingerprint -> cached image build"
Write-Host ""
...
$report = [ordered]@{
    ...
    toolchain = [ordered]@{
        ...
        azure_cli = (Docker-Capture "az --version 2>/dev/null | head -n 1")
