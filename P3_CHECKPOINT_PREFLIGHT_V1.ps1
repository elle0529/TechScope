...
Write-Host ""
Write-Host "TechScope P3 Checkpoint + Preflight v1"
Write-Host "Checkpoint completed P1E, then inspect P3 Cosmos/Session/Feedback state"
Write-Host ""
...
Copy-Item `
    (Join-Path $PSScriptRoot "_techscope_payload\tools\p3_checkpoint_preflight_v1.py") `
    (Join-Path $Repo "tools\p3_checkpoint_preflight_v1.py") `
    -Force

Write-Host "P3_CHECKPOINT_PREFLIGHT_TOOL=INSTALLED"
...
if($LASTEXITCODE-ne 0){
    throw "TECHSCOPE_P3_CHECKPOINT_PREFLIGHT_V1=FAIL"
}
